...
const ALL_PRS = [
  { id: 145, title: "feat: terminal3 agent-auth grant flow",   agent: "vault-agent",     status: "review",  comments: 2,  additions: 57,  deletions: 4,  branch: "feat/t3-grants",        time: "Just now" },
  { id: 144, title: "fix: scoped credential ttl boundary",     agent: "policy-agent",    status: "review",  comments: 1,  additions: 18,  deletions: 3,  branch: "fix/ttl-boundary",      time: "1m ago" },
  { id: 143, title: "feat: sealed secret map seed audit",      agent: "audit-agent",     status: "merged",  comments: 4,  additions: 93,  deletions: 11, branch: "feat/seed-audit",      time: "1m ago" },
  { id: 142, title: "feat: add revoke marker enforcement",     agent: "vault-agent",     status: "merged",  comments: 3,  additions: 84,  deletions: 12, branch: "feat/revoke-map",      time: "2m ago" },
  { id: 141, title: "fix: allowed host grant validation",      agent: "policy-agent",    status: "approved",comments: 1,  additions: 31,  deletions: 8,  branch: "fix/host-grants",       time: "8m ago" },
  { id: 140, title: "feat: placeholder proxy contract",        agent: "research-agent",  status: "review",  comments: 5,  additions: 142, deletions: 27, branch: "feat/hwp-proxy",       time: "22m ago" },
  { id: 139, title: "refactor: audit ledger persistence",      agent: "audit-agent",     status: "merged",  comments: 7,  additions: 209, deletions: 88, branch: "refactor/audit-store", time: "1h ago" },
]
...
const COMMITS = [
  ...
  { hash: "c9a1f34", msg: "chore: bump @terminal3/t3n-sdk to 3.9.0",    time: "12m ago"  },
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          }}>agentvault / policy-console — main</span>
