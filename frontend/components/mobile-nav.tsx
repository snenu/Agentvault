...
const NAV_LINKS = [
  ...
  { label: "Terminal3",    href: "/terminal3" },
]
...
export function MobileNav() {
  ...
  return (
    <div className="fixed top-4 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
      <div className="pointer-events-auto w-[calc(100vw-32px)] max-w-3xl overflow-hidden">

        {/* Main bar */}
        <nav
          className="flex items-center justify-between px-4 py-3 sm:px-5 rounded-2xl border border-black/[0.06]"
          style={NAV_STYLE}
        >
          <a href="/" className="min-w-0 truncate font-pixel text-[10px] tracking-[0.16em] text-black/70 sm:text-xs sm:tracking-[0.25em]">AGENTVAULT</a>
